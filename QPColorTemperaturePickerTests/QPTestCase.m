...
- (void)assertColor:(UIColor *)colorA equalsColor:(UIColor *)colorB {
  ...
  QPGetComponentsForColor(rgbaA, colorA);
  QPGetComponentsForColor(rgbaB, colorB);
  ...
  XCTAssert((fabs(rgbaA[0] - rgbaB[0]) < kColorComponentAccuracy) &&
            ...
            @"Color %@ does not equal color %@, but they should be equal",
            colorA, colorB);
}
- (void)assertColor:(UIColor *)colorA notEqualsColor:(UIColor *)colorB {
  ...
  XCTAssert((fabs(rgbaA[0] - rgbaB[0]) > kColorComponentAccuracy) ||
                ...
                (fabs(rgbaA[2] - rgbaB[2]) > kColorComponentAccuracy) ||
                (fabs(rgbaA[3] - rgbaB[3]) > kColorComponentAccuracy),
            @"Color %@ is too similar to %@, but they should not be equal",
            colorA, colorB);
}
