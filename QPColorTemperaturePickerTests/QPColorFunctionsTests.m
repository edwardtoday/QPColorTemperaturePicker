//
//  QPColorFunctionsTests.m
//  QPColorTemperaturePicker
//
//  Created by Pei Qing on 3/16/14.
//
//
...
@interface QPColorFunctionsTests : QPTestCase

@end

@implementation QPColorFunctionsTests
...
- (void)testHSVFromPixel {
  ...
  UIColor *color2 =
      [UIColor colorWithHue:h saturation:s brightness:v alpha:1.0];
...
- (void)testComponentsForColor_rgb {
  ...
  QPGetComponentsForColor(components, color);

  testColor = [UIColor colorWithRed:components[0]
                              green:components[1]
                               blue:components[2]
                              alpha:components[3]];
...
- (void)testComponentsForColor_hsv {
  UIColor *color =
      [UIColor colorWithHue:0 saturation:1.0 brightness:1.0 alpha:0.4];
  UIColor *testColor;
...
- (void)testComponentsForColor_cmyk {
  ...
  UIColor * (^colorFromCMYK)(CGFloat C, CGFloat M, CGFloat Y, CGFloat K,
                             CGFloat A) =
      ^UIColor * (CGFloat C, CGFloat M, CGFloat Y, CGFloat K, CGFloat A) {
...
- (void)testRandomColor {
  ...
  UIColor *color = QPRandomColorOpaque(YES);
