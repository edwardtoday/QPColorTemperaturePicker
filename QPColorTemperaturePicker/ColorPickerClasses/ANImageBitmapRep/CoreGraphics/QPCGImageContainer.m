...
@implementation QPCGImageContainer
...
+ (CGImageContainer *)imageContainerWithImage:(CGImageRef)anImage {
  CGImageContainer *container =
      [(CGImageContainer *)[CGImageContainer alloc] initWithImage:anImage];
...
__attribute__((ns_returns_autoreleased)) id
    CGImageReturnAutoreleased(CGImageRef original) {
